<x-layout title="FAQ">
    <div class="mx-auto max-w-3xl">
        ...
        @php
            $faqs = [
                [
                    'question' => 'What products does ' . config('business.name') . ' sell?',
                    'answer' => 'We sell major household electrical appliances — including LED TVs, air conditioners, refrigerators, washing machines, dishwashers, microwaves, electric geysers, and electrical ovens — sourced from reputable brands for quality and reliability.',
                ],
                [
                ...
                [
                    'question' => 'How can I contact ' . config('business.name') . '?',
                    'answer' => "You can reach us anytime through our <a href=\"" . route('contact') . "\" class=\"font-medium text-slate-900 hover:underline\">Contact page</a>, by emailing " . config('business.email') . ", or by phone at " . config('business.phone') . '.',
                ],
                [
